            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        <h2 className="h2 mb-4">Siz nima uchun bizning kompaniyamizni tanlashingiz kerak?</h2>
                        <p className="text-xl text-gray-400">Bizning kompaniyamizni boshqa kompaniyalaga qaraganda
                            ko'plab qulayliklarga ega. Siz qulaylik haqida tanishib chiqishingiz mumkin</p>
                    </div>
                    ...
                    <div
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up"
                            ...
                            <h4 className="h4 mb-2">Bizda Arzonroq</h4>
                            <p className="text-lg text-gray-400 text-center">Nima uchun? Chunki biz mahsulotlarni
                                to'g'ridan to'g'ri ishlab chiqaruvchidan olamiz!</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <h4 className="h4 mb-2">Bizda Sifatli</h4>
                            <p className="text-lg text-gray-400 text-center">Chunki biz bilan hamkorlik qiluvchi ishlab
                                chiqaruvchilar yetakchi va sifatli brend egalaridir</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
                            ...
                            <h4 className="h4 mb-2">10 yillik tajriba</h4>
                            <p className="text-lg text-gray-400 text-center">Alliance — 2013-yilda tashkil etilgan
                                kompaniya boʻlib, Oʻzbekiston boʻylab korxonalar va xususiy uy xoʻjaliklari uchun quyosh
                                panellarining keng tanlovi va oʻrnatilishini taʼminlaydi.</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300"
                            ...
                            <h4 className="h4 mb-2">Mahsulot Sifati</h4>
                            <p className="text-lg text-gray-400 text-center">Quyosh panellari deyarli cheksiz xizmat
                                qiladi, 30 yil ichida unumdorligi faqatgina kichik pasayadi</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400"
                            ...
                            <h4 className="h4 mb-2">O'z ishining ustalari</h4>
                            <p className="text-lg text-gray-400 text-center">- Panellarning funksionalligini
                                tekshirish. <br/>
                                - Quyosh modullarini tozalash va texnik xizmat ko'rsatish. <br/>
                                - Maksimal samaradorlik uchun ishlash monitoringi. <br/>
                                - Tizimli diagnostika va uskunalarni yangilash</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500"
                            ...
                            <h4 className="h4 mb-2">Bepul Servis</h4>
                            <p className="text-lg text-gray-400 text-center">Bundan tashqari mijozlarimiz uchun qulaylik
                                yaratish maqsadida 1-yillik bepul servis xizmati ham mavjud</p>
                        </div>
