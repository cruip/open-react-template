      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.forest.200),theme(colors.gray.50),theme(colors.forest.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-4 font-raleway text-3xl font-semibold text-transparent md:text-4xl">
              Comprehensive IT Solutions to Scale Your Business            </h2>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              <svg
                className="mb-3 fill-forest-500"
              ...
              <h3 className="mb-1 font-menda font-bold text-[1.5rem] text-gray-200">
                Project Milestones
              </h3>
            ...
            <article>
              ...
              <h3 className="mb-1 font-raleway text-[1rem] font-semibold text-gray-200">
                Team Views
              </h3>
              <p className="text-forest-200/65">
                Track progress across custom flows for your team. Find the right
