          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            <article>
              ...
              <p className="text-forest-200/65">
                ...
                Whether it’s a customer-facing app or a business tool, we design, develop and deploy apps, that deliver seamless
                user experiences{" "}
              </p>
            </article>
            <article>
            ...
            <article>
              ...
              <p className="text-forest-200/65">
                Navigate the complexities of modern IT infrastructure with our consulting and cloud services. We help businesses
                with cloud migration, infrastructure optimization and digital transformation strategies, while ensuring
            ...
            <article>
              ...
              <p className="text-forest-200/65">
                Boost your online presence with our comprehensive digital marketing services. From SEO and content marketing to
                social media management and paid ad campaigns, we craft data-driven strategies that maximize your ROI and drive
                measurable growth{" "}
              </p>
            </article>
            <article>
              ...
              <p className="text-forest-200/65">
                We specialize in developing custom content management systems (CMS) tailored to your business needs. From
                WordPress and Shopify to Drupal and Joomla, we offer seamless integrations, tailored e-commerce solutions, plugin
                development, theme customization and much more… to drive your online presence.{" "}
              </p>
            </article>
          </div>
        </div>
