                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-400 text-center">
                                Crafting high-performance iOS apps that
                                captivate and engage users with seamless
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-400 text-center">
                                Delivering robust and user-friendly Android
                                applications tailored to meet your business
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-400 text-center">
                                Providing ongoing maintenance and support to
                                ensure your app remains up-to-date and performs
                                optimally.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-400 text-center">
                                Creating efficient and user-friendly POS systems
                                that simplify transactions and improve business
                                operations.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <h4 className="h4 mb-2 text-center">
                                Healthcare and IoT App Development
                            </h4>
                            <p className="text-lg text-gray-400 text-center">
                                Developing cutting-edge healthcare and IoT
                                applications that harness the latest technology
                                to enhance patient care and connectivity.
                            </p>
                        </div>
                    </div>
                </div>
