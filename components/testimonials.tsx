...
const testimonials = [
  {
    ...
    company: "Disney",
    content:
      "SafePyme transformed our approach to cybersecurity. Previously, we felt vulnerable to attacks, but with SafePyme’s real-time monitoring and automated response, we now have peace of mind.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Samsung",
    content:
      "We were looking for a cost-effective SOC solution that didn’t compromise on features. SafePyme delivered! The continuous threat detection and user-friendly interface make it easy for our small team to stay on top of potential risks.",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Rio",
    content:
      "The setup was straightforward, and the visualization tools help us keep track of security events effortlessly. This SOC solution is a game-changer for our small business. It is intuitive and produces top-notch content every time. It's like having an extra team member who never sleeps!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "As a small agency, we needed a solution that was reliable but also affordable. SafePyme fit the bill perfectly. Their cloud setup was easy to integrate with our existing systems, and the support team helped us understand how to get the most out of the platform. Highly recommended!",
    categories: [1, 4],
  },
  {
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            We provide Enterprise-Level Security for Small Businesses to
            build fortified workspaces from anywhere in the world.
          </p>
        </div>
