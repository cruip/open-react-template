      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">The future of Brick & Mortar in store retail is full automation.</h2>
            <p className="text-xl text-gray-400">With the rise of curbside grocery pickup post pandemic, customers expect rapid and seamless order fulfillment </p>
          </div>
