        ...
        <div className="py-12 md:py-20">
          ...
          <div className="pb-12 text-center md:pb-20">
            ...
            <div className="mx-auto max-w-3xl">
              <p
                className="mb-8 text-xl text-forest-200/65 font-normal"
                data-aos="fade-up"
                data-aos-delay={200}
              >
            ...
            <div data-aos="fade-up" data-aos-delay={400}>
              <a
                className="btn group mb-4 w-full bg-gradient-to-t from-forest-600 to-forest-500 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_theme(colors.white/.16)] hover:bg-[length:100%_150%] sm:mb-0 sm:w-auto rounded-full px-16 mt-8"
                href="#0"
              >
