        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="py-12 md:py-5 border-t border-gray-800">
            ...
            <div className="mb-8">
              ...
              <div className="text-gray-400">Transform your gaming experience and influence the future of game development with Cycle. Because when it comes to making games better, it's your voice that makes all the difference.</div>
            </div>

            {/* Bottom area */}
            <div className="md:flex md:items-center md:justify-between">
              {/* Copyrights note */}
              <div className="text-gray-400 text-sm mr-4">&copy; Cycle.com. All rights reserved.</div>
